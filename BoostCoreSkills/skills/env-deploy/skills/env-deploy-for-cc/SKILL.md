...
description: Use in Claude Code when asked to automatically deploy a local, cloned, or SSH-remote Linux code project's runtime environment, including project detection, dependency planning, optional command execution, build, unit-test verification, reproducible setup script generation, deployment logging, and final reporting. Supports C++, Python, Go, Java, and Docker projects. Must pause for driver conflicts, unresolved test failures, credentials, and ambiguous project or build-tool choices.
allowed-tools: "Read Write Edit Bash Glob Grep"
metadata:
  version: "1.0.0"
  short-description: "Automate local or SSH Linux deployment"
---
